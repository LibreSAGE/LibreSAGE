...
public:
	...
	void init( Real width, Real length, Vector2 &start, Vector2 &end, const Char *texturename, Int waveTimeOffset);	///<allocate W3D resources and set size
	void init( Real width, Vector2 &start, Vector2 &end, const Char *texturename);	///<allocate W3D resources and set size
