...
public:
	...
	static Bool testMinimumRequirements(ChipsetType *videoChipType, CpuType *cpuType, Int *cpuFreq, Int64 *numRAM, Real *intBenchIndex, Real *floatBenchIndex, Real *memBenchIndex);
