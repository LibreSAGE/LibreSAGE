...
void CrateCollideModuleData::buildFieldParse(MultiIniFieldParse& p) 
{
  ModuleData::buildFieldParse(p);
	...
	static const FieldParse dataFieldParse[] = 
	{
		...
		{ "PickupScience", ScienceStore::parseScience,	NULL,	offsetof( CrateCollideModuleData, m_pickupScience ) },
		{ "ExecuteFX", FXListStore::parseFXList, NULL, offsetof( CrateCollideModuleData, m_executeFX ) },
