...
class Listener3DClass : public Sound3DClass
{
	...
	protected:
		...
		virtual void			Set_Sample_Volume (int32_t volume)			{ }
		virtual int32_t			Get_Sample_Volume (void)					{ return 0; }
		virtual void			Set_Sample_Pan (int32_t pan)					{ }
		virtual int32_t			Get_Sample_Pan (void)						{ return 64; }
		virtual void			Set_Sample_Loop_Count (uint32_t count)		{ }
		virtual uint32_t		Get_Sample_Loop_Count (void)				{ return 0; }
		virtual void			Set_Sample_MS_Position (uint32_t ms)			{ }
		virtual void			Get_Sample_MS_Position (int32_t *len, int32_t *pos) { }
		virtual int32_t			Get_Sample_Playback_Rate (void)			{ return 0; }
		virtual void			Set_Sample_Playback_Rate (int32_t rate)		{ }
