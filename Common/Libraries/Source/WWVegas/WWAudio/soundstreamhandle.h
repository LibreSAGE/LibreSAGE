...
public:
...
#else
	void*						Get_HSAMPLE (void)		{ return NULL; }
	void*						Get_HSTREAM (void)		{ return NULL; }
#endif
	...
	void							Set_Sample_User_Data (int32_t i, uintptr_t val);
	uintptr_t						Get_Sample_User_Data (int32_t i);
