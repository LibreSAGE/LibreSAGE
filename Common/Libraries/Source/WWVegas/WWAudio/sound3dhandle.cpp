...
//////////////////////////////////////////////////////////////////////
void
Sound3DHandleClass::Set_Sample_Pan (int32_t /*pan*/)
{
	return ;
}
...
//////////////////////////////////////////////////////////////////////
void
Sound3DHandleClass::Set_Sample_Volume (int32_t volume)
{
#ifdef SAGE_USE_MILES
	if (SampleHandle != (H3DSAMPLE)INVALID_MILES_HANDLE) {
...
//////////////////////////////////////////////////////////////////////
void
Sound3DHandleClass::Set_Sample_Loop_Count (uint32_t count)
{
#ifdef SAGE_USE_MILES
	if (SampleHandle != (H3DSAMPLE)INVALID_MILES_HANDLE) {
...
//////////////////////////////////////////////////////////////////////
void
Sound3DHandleClass::Set_Sample_MS_Position (uint32_t ms)
{
#ifdef SAGE_USE_MILES
	if (SampleHandle != (H3DSAMPLE)INVALID_MILES_HANDLE) {

		WWASSERT (Buffer != NULL);
		uint32_t bytes_per_sec = (Buffer->Get_Rate () * Buffer->Get_Bits ()) >> 3;
		uint32_t bytes = (ms * bytes_per_sec) / 1000;
		bytes += (bytes & 1);
...
//////////////////////////////////////////////////////////////////////
void
Sound3DHandleClass::Get_Sample_MS_Position (int32_t *len, int32_t *pos)
{
#ifdef SAGE_USE_MILES
	if (SampleHandle != (H3DSAMPLE)INVALID_MILES_HANDLE) {
...
//////////////////////////////////////////////////////////////////////
void
Sound3DHandleClass::Set_Sample_User_Data (int32_t i, uintptr_t val)
{
#ifdef SAGE_USE_MILES
	if (SampleHandle != (H3DSAMPLE)INVALID_MILES_HANDLE) {
...
//////////////////////////////////////////////////////////////////////
uintptr_t
Sound3DHandleClass::Get_Sample_User_Data (int32_t i)
{
	uintptr_t retval = 0;
#ifdef SAGE_USE_MILES
	if (SampleHandle != (H3DSAMPLE)INVALID_MILES_HANDLE) {
...
//////////////////////////////////////////////////////////////////////
void
Sound3DHandleClass::Set_Sample_Playback_Rate (int32_t rate)
{
#ifdef SAGE_USE_MILES
	if (SampleHandle != (H3DSAMPLE)INVALID_MILES_HANDLE) {
