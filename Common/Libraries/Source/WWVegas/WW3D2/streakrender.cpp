		...
		*/		
		...
		// Copy in the data to the  VB
		{
			...
			for (i=0; i<vnum; i++)
			{
				...
				DEBUG_ASSERTCRASH((WWMath::Is_Valid_Float(vertexArray[i].x) && WWMath::Is_Valid_Float(vertexArray[i].y) && WWMath::Is_Valid_Float(vertexArray[i].z)) , ("Bad vertexArray[%d]", i));
