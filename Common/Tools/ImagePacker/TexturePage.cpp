...
Bool TexturePage::generateTexture( void )
{
	...
	if( m_packedImage == NULL )
	{
		...
		DEBUG_ASSERTCRASH( m_packedImage, ("Unable to allocate final packed image buffer\n") );
		TheImagePacker->reportError( "Internal Error", "Unable to allocate final packed image buffer" );
...
//=============================================================================
Bool TexturePage::writeFile( const char *baseFilename )
{
