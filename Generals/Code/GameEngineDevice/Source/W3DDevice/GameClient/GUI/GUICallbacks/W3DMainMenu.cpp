...
void W3DMainMenuDraw( GameWindow *window, WinInstanceData *instData )
{
	...
	IRegion2D	topHorizontal1drop ={pos.x, (Int)(pos.y+1), pos.x + size.x, (Int)(pos.y+1)	};
	...
	IRegion2D	bottomHorizontal2= {pos.x, (Int)(pos.y + size.y), pos.x + size.x, (Int)(pos.y + size.y) 	};
	IRegion2D	bottomHorizontal2drop= {pos.x, (Int)(pos.y + size.y + 1), pos.x + size.x, (Int)(pos.y + size.y + 1)	};
...
void W3DMainMenuFourDraw( GameWindow *window, WinInstanceData *instData )
{
	...
	//IRegion2D	verticle3 ={pos.x + (Int)(size.x * .6662), pos.y, pos.x + (Int)(size.x * .6662), height 	};
	IRegion2D	verticle4 ={pos.x + (Int)(size.x * .885), pos.y , pos.x + (Int)(size.x * .885), height 	};
//	static IRegion2D	verticle5 ={pos.x + (Int)(size.x * .7250), pos.y + (Int)(size.y * .12), pos.x + (Int)(size.x * .7250), pos.y + (Int)(size.y * .86) 	};
//	static IRegion2D	verticle6 ={pos.x + (Int)(size.x * .9062), pos.y + (Int)(size.y * .12), pos.x + (Int)(size.x * .9062), pos.y + (Int)(size.y * .86) 	};
