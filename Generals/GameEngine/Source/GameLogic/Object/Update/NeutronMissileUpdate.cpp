...
void NeutronMissileUpdateModuleData::buildFieldParse(MultiIniFieldParse& p)
{
  UpdateModuleData::buildFieldParse(p);
	...
	static const FieldParse dataFieldParse[] = 
	{
		...
		{ "LaunchFX",					FXListStore::parseFXList,		NULL, offsetof( NeutronMissileUpdateModuleData, m_launchFX ) },
		...
		{ "IgnitionFX",				FXListStore::parseFXList,		NULL, offsetof( NeutronMissileUpdateModuleData, m_ignitionFX ) },
