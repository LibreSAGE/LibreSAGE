 ...
 */
//=============================================================================
void WaterTracksObj::init( Real width, Real length, Vector2 &start, Vector2 &end, const Char *texturename, Int waveTimeOffset)
{	
 ...
 */
//=============================================================================
void WaterTracksObj::init( Real width, Vector2 &start, Vector2 &end, const Char *texturename)
{	
	freeWaterTracksResources();	//free old resources used by this track
	m_boundingSphere.Init(Vector3(0,0,0),400);
	m_boundingBox.Center.Set(0.0f, 0.0f, 0.0f);
